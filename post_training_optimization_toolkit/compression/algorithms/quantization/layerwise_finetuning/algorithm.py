...
class QuantizeModelFinetuning(LayerwiseModelFinetuning):
    ...
    def __init__(self, config, engine):
        ...
        tuning_config = {
            ...
            'scale_lr': 1e-6,
            'min_lr': 1e-6,
            'num_samples_for_tuning': 500000, # default 5000
            'batch_size': 25,
        ...
        #     'weights_lr': 1e-6,
        #     'bias_lr': 1e-5,
        #     'weight_fq.scale_lr': 1e-7,
        #     'weight_fq.min_lr': 1e-7,
        #     'input_fq.scale_lr': 1e-7,
        #     'input_fq.min_lr': 1e-7,
        #     'scale_lr': 1e-7,
        #     'min_lr': 1e-7,
        #     'num_samples_for_tuning': 500, # default 5000
        #     'batch_size': 100,
        #     'calibration_indices_pool': 300,
        #     'calculate_grads_on_loss_increase_only': False,
        #     'set_quantized_values_to_weight_parameter': True,
    ...
    def run(self, model):
        ...
        self._tconf["weights_lr"] = 1e-6
        self._tconf["bias_lr"] = 1e-5
        self._tconf["weight_fq.scale_lr"] = 1e-7
        self._tconf["weight_fq.min_lr"] = 1e-7
        self._tconf["input_fq.scale_lr"] = 1e-7
        self._tconf["input_fq.min_lr"] = 1e-7
        self._tconf["scale_lr"] = 1e-7
        self._tconf["min_lr"] = 1e-7
