...
ov::npuw::LLMCompiledModel::LLMCompiledModel(const std::shared_ptr<ov::Model>& model,
    ...
    if (is_moe) {
        ...
        // Apply some basic folding transformations to simplify the model before applying more complex MoE
        // transformations, as they might interfere with pattern matching for Qwen3-30B-A3B.
        {
            ov::pass::GraphRewrite fold_rewr;
            fold_rewr.add_matcher<ov::npuw::patterns::util::FoldShapeOf>();
            fold_rewr.add_matcher<ov::npuw::patterns::util::FoldGatherOfConst>();
            fold_rewr.add_matcher<ov::npuw::patterns::util::FoldUnsqueezeOfConst>();
            fold_rewr.add_matcher<ov::npuw::patterns::util::FoldConcatOfConsts>();
            fold_rewr.run_on_model(prefill_model);
        }
